...
const gfx::Size kTooltipSize(424 + 15, 94 + 15);
...
BraveTooltipView::BraveTooltipView(
    ...
    : tooltip_id_(tooltip_id), tooltip_attributes_(tooltip_attributes) {
...
void BraveTooltipView::Close() {
  ...
  BraveTooltipPopup::Close(tooltip_id_, /* by_user */ true);
}
...
void BraveTooltipView::OnOkButtonPressed() {
  BraveTooltipPopup::OnOkButtonPressed(tooltip_id_);
}
...
void BraveTooltipView::OnCancelButtonPressed() {
  BraveTooltipPopup::OnCancelButtonPressed(tooltip_id_);
}
